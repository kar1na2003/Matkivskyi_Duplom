...
Output:
  - plots/report_accuracy_3scenarios.png
  - plots/report_f1_comparison.png
  - plots/report_pareto.png
  - plots/report_scenario_delta.png
  - camera_bench_report.csv
"""
...
CSV_OUT = Path(__file__).resolve().parent.parent / "camera_bench_report.csv"
