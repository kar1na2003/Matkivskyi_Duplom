...
/*******************************************************************************
* Function Name: debug_uart_hal
********************************************************************************
* Summary:
*  Returns the HAL UART object used by retarget_io, so other modules (e.g.
*  comm_task) can reconfigure it at runtime (e.g. to change baud rate).
*
* Return:
*  Pointer to the HAL UART object, or NULL before init_retarget_io() has run.
*******************************************************************************/
mtb_hal_uart_t *debug_uart_hal(void);
